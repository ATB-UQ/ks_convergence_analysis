...
for data_path in TEST_DATA:
    ...
    minimum_sampling_time, equilibration_time, largest_converged_block_minimum_ks_value, largest_converged_block_minimum_p_value, fig = ks_convergence_analysis(x, y)
    fig.tight_layout()
    ...
    print "Minimum ks statistic in equilibrated region: {0:5.3g}".format(largest_converged_block_minimum_ks_value)
    print "Minimum p value in equilibrated region: {0:5.3g}".format(largest_converged_block_minimum_p_value)
    print
